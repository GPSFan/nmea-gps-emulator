...
For **Meshtatic** only GPGGA and GPRMC sentences are sent.
NMEA sentences generated by **NMEA-GPS Emulator** script when nmea_gps_full.py is used instead of nmea_gps.py:
```
